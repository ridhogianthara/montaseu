                        ...
                        <tr>
                            ...
                            <td style="background: rgba(16, 185, 129, 0.03); text-align:center;">
                                <?php if ($r['clock_in_lat'] && $r['clock_in_lng']): ?>
                                    <button class="btn-gold" style="font-size:0.7rem; padding:3px 7px;" onclick="viewMapModal(<?= $r['clock_in_lat'] ?>, <?= $r['clock_in_lng'] ?>, '<?= addslashes(sanitize($r['clock_in_address'] ?? '')) ?>', 'Peta Masuk: <?= date('d/m/Y', strtotime($r['date'])) ?>')">
                            ...
                            <td style="background: rgba(197, 168, 128, 0.03); max-width:180px; font-size:0.8rem;">
                                <?php if ($r['clock_out_time']): ?>
                            ...
                            <td style="background: rgba(197, 168, 128, 0.03); text-align:center;">
                                <?php if ($r['clock_out_lat'] && $r['clock_out_lng']): ?>
                                    <button class="btn-secondary" style="font-size:0.7rem; padding:3px 7px;" onclick="viewMapModal(<?= $r['clock_out_lat'] ?>, <?= $r['clock_out_lng'] ?>, '<?= addslashes(sanitize($r['clock_out_address'] ?? '')) ?>', 'Peta Pulang: <?= date('d/m/Y', strtotime($r['date'])) ?>')">
